== README FOR BETA 0.0.1 	[THE FIRST HALF OF THIS GUIDE IS JUST GETTING THE DB TO CONFORM TO RAILS STANDARDS]
*OPEN THIS FILE IN A TEXT	[THIS WILL NOT BE NEEDED TO BE DONE IN LATER IMPLEMENTATIONS OF THE APP]
*EDITOR OR ELSE THE FORMATTING	[ITS BETA FOR GODSAKE GIVE ME A BREAK - Richard Stallman]
*IS FUCKED
