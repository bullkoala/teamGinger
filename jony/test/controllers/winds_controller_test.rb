...
class WindsControllerTest < ActionController::TestCase
  ...
  test "should create wind" do
    assert_difference('Wind.count') do
      post :create, wind: { description: @wind.description, keywords: @wind.keywords, typeID: @wind.typeID }
    end
  ...
  test "should update wind" do
    patch :update, id: @wind, wind: { description: @wind.description, keywords: @wind.keywords, typeID: @wind.typeID }
    assert_redirected_to wind_path(assigns(:wind))
  end
