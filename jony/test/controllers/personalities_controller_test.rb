...
class PersonalitiesControllerTest < ActionController::TestCase
  ...
  test "should create personality" do
    assert_difference('Personality.count') do
      post :create, personality: { chi: @personality.chi, clan: @personality.clan, description: @personality.description, familyHonorRequirement: @personality.familyHonorRequirement, goldCost: @personality.goldCost, keywords: @personality.keywords, personalHonor: @personality.personalHonor, strength: @personality.strength, typeID: @personality.typeID }
    end
  ...
  test "should update personality" do
    patch :update, id: @personality, personality: { chi: @personality.chi, clan: @personality.clan, description: @personality.description, familyHonorRequirement: @personality.familyHonorRequirement, goldCost: @personality.goldCost, keywords: @personality.keywords, personalHonor: @personality.personalHonor, strength: @personality.strength, typeID: @personality.typeID }
    assert_redirected_to personality_path(assigns(:personality))
  end
