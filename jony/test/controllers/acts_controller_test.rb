...
class ActsControllerTest < ActionController::TestCase
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post :create, act: { description: @act.description, focus: @act.focus, goldCost: @act.goldCost, keywords: @act.keywords, typeID: @act.typeID }
    end
  ...
  test "should update act" do
    patch :update, id: @act, act: { description: @act.description, focus: @act.focus, goldCost: @act.goldCost, keywords: @act.keywords, typeID: @act.typeID }
    assert_redirected_to act_path(assigns(:act))
  end
