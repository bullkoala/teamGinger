...
class RingsControllerTest < ActionController::TestCase
  ...
  test "should create ring" do
    assert_difference('Ring.count') do
      post :create, ring: { description: @ring.description, focus: @ring.focus, keywords: @ring.keywords, typeID: @ring.typeID }
    end
  ...
  test "should update ring" do
    patch :update, id: @ring, ring: { description: @ring.description, focus: @ring.focus, keywords: @ring.keywords, typeID: @ring.typeID }
    assert_redirected_to ring_path(assigns(:ring))
  end
